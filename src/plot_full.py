# -*- coding: utf-8 -*-
## @file plot_full.py  (этот комментарий остаётся для имени файла)
...
def main() -> None:
    ...
    """
    try:
        X, Y, u_num = read_full_solution('solution.bin')
    ...
    plt.axis('equal')
    plt.tight_layout()
    plt.savefig('error_map.png', dpi=300)
    print("Error map saved as error_map.png")
